...
# TODO Think about umlauts. Will that have an effect on how the input is given?
# Replace umlauts with ae ue oe?
#

words = ["sein", "haben", "werden", "können", "müssen", "sagen", "machen",
"geben", "kommen", "sollen", "wollen", "gehen", "wissen", "sehen", "lassen",
"stehen", "finden", "bleiben", "liegen", "heißen", "denken", "nehmen", "tun",
"dürfen", "glauben", "halten", "nennen", "mögen", "zeigen", "führen",
"sprechen", "bringen", "leben", "fahren", "meinen", "fragen", "kennen",
"gelten", "stellen", "spielen", "arbeiten", "brauchen", "folgen", "lernen",
"bestehen", "verstehen", "setzen", "bekommen", "beginnen", "erzählen",
"versuchen", "schreiben", "laufen", "erklären", "entsprechen", "sitzen",
"ziehen", "scheinen", "fallen", "gehören", "entstehen", "erhalten", "treffen",
...
"betreffen", "warten", "vergehen", "helfen", "gewinnen", "schließen", "fühlen",
